 ...
 */
public class FirstSemester5 extends Fragment implements RecyclerInterface, ClickInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_first_semester5, container, false);

        context = getContext();
        courseListArrayList = new ArrayList<>();
        recyclerView = view.findViewById(R.id.recycler_view_first);
        fab = view.findViewById(R.id.fab_first);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        adapter = new CourseListAdapter(context, FirstSemester5.this, courseListArrayList, this, this);
        ...
        ArrayList<CourseList> oldData = new MySqLiteConnector(getContext()).getCourse5_1();
    ...
    private void saveNewCourse(String course, String credit) {
        boolean insert = connector.saveCourse5_1(course, credit);
        if(insert) {
    ...
    private void saveTimelineCourse(String course, String grade) {
        boolean insert = connector.saveTimelineCourse5_1(course, grade);
        if(insert) {
            Toast.makeText(getContext(), "Saved", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(getContext(), " Couldn't Save", Toast.LENGTH_LONG).show();
    ...
    public void getPosition(int position, String data) {
        ArrayList<CourseList> list = connector.getCourse5_1();
        int id = list.get(position).getId();
        connector.updateCredit5_1(id, data);
    }

    @Override
    public void OnLongClick(final int position) {
        ArrayList<CourseList> list2 = connector.getCourse5_1();
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                connector.deleteFromCourse5_1(id, course);
                connector.deleteFromTimelineCourse5_1(id, course);
