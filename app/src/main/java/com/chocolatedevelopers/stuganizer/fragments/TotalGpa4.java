 ...
 */
public class TotalGpa4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_total_gpa4, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<CourseList> credit = connector.getCredit4_1();
                ArrayList<CourseList> credit2 = connector.getCredit4_2();
                ArrayList<TimelineList> grade = connector.getGrade4_1();
                ArrayList<TimelineList> grade2 = connector.getGrade4_2();
