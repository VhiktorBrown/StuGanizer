 ...
 */
public class TimelineFirst3 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_timeline_first3, container, false);
        ...
        adapter = new TimelineListAdapter(context, TimelineFirst3.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit3_1();
        ArrayList<TimelineList> allGrades = connector.getGrade3_1();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse3_1();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse3_1();
        if (list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade3_1(id, data);
        }
