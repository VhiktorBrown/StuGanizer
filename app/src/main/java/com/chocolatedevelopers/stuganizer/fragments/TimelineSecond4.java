 ...
 */
public class TimelineSecond4 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_timeline_second4, container, false);
        context = getContext();
        recyclerView = view.findViewById(R.id.timeline_recycler_2);
        timelineListArrayList = new ArrayList<>();
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        adapter = new TimelineListAdapter(context, TimelineSecond4.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit4_2();
        ArrayList<TimelineList> allGrades = connector.getGrade4_2();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse4_2();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse4_2();
        if(list.size() > 0) {
            int id = timelineListArrayList.get(position).getId();
            connector.updateGrade4_2(id, data);
        }
