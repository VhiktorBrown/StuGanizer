 ...
 */
public class FirstSemester extends Fragment implements RecyclerInterface, ClickInterface {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new CourseListAdapter(context, FirstSemester.this, courseListArrayList, this, this);
        ...
        Cursor cursor1 = connector.getSave3();
        ...
        ArrayList<CourseList> oldData = new MySqLiteConnector(getContext()).getCourse1_1();
    ...
    public void showTargetView() {
        TapTargetView.showFor(getActivity(),
                TapTarget.forView(view.findViewById(R.id.fab_first), "Add a course", "Click here to add a new course")
    ...
    public void OnLongClick(final int position) {
        ArrayList<CourseList> list2 = connector.getCourse1_1();
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                connector.deleteFromCourse1_1(id, course);
                connector.deleteFromTimelineCourse1_1(id, course);
    ...
    public void getPosition(int position, String data) {
        ArrayList<CourseList> list = connector.getCourse1_1();
        int id = list.get(position).getId();
        connector.updateCredit1_1(id, data);
    }
}
