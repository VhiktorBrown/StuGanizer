 ...
 */
public class TimelineSecond3 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_timeline_second3, container, false);
        context = getContext();
        recyclerView = view.findViewById(R.id.timeline_recycler_2);
        timelineListArrayList = new ArrayList<>();
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        adapter = new TimelineListAdapter(context, TimelineSecond3.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit3_2();
        ArrayList<TimelineList> allGrades = connector.getGrade3_2();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse3_2();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse3_2();
        if(list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade3_2(id, data);
        }
