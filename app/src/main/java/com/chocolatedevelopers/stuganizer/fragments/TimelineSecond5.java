 ...
 */
public class TimelineSecond5 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_timeline_second5, container, false);
        ...
        adapter = new TimelineListAdapter(context, TimelineSecond5.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit5_2();
        ArrayList<TimelineList> allGrades = connector.getGrade5_2();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse5_2();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse5_2();
        if(list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade5_2(id, data);
        }
