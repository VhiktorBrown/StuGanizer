 ...
 */
public class TotalGpa5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_total_gpa5, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<CourseList> credit = connector.getCredit5_1();
                ArrayList<CourseList> credit2 = connector.getCredit5_2();
                ArrayList<TimelineList> grade = connector.getGrade5_1();
                ArrayList<TimelineList> grade2 = connector.getGrade5_2();
