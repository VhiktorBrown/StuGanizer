 ...
 */
public class SecondSemester2 extends Fragment implements RecyclerInterface, ClickInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_second_semester2, container, false);
        ...
        adapter = new CourseListAdapter(context, SecondSemester2.this, courseListArrayList, this, this);
        ...
        ArrayList<CourseList> oldData = new MySqLiteConnector(getContext()).getCourse2_2();
    ...
    private void saveNewCourse(String course, String credit) {
        boolean insert = connector.saveCourse2_2(course, credit);
        if(insert) {
    ...
    private void saveTimelineCourse(String course, String grade) {
        boolean insert = connector.saveTimelineCourse2_2(course, grade);
        if(insert) {
            Toast.makeText(getContext(), "Saved", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(getContext(), " Couldn't Save", Toast.LENGTH_LONG).show();
    ...
    public void getPosition(int position, String data) {
        ArrayList<CourseList> list = connector.getCourse2_2();
        int id = list.get(position).getId();
        connector.updateCredit2_2(id, data);
    }

    @Override
    public void OnLongClick(final int position) {
        ArrayList<CourseList> list2 = connector.getCourse2_2();
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                connector.deleteFromCourse2_2(id, course);
                connector.deleteFromTimelineCourse2_2(id, course);
