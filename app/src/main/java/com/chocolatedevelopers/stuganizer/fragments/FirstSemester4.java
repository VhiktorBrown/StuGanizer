 ...
 */
public class FirstSemester4 extends Fragment implements RecyclerInterface, ClickInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_first_semester4, container, false);
        ...
        adapter = new CourseListAdapter(context, FirstSemester4.this, courseListArrayList, this, this);
        ...
        ArrayList<CourseList> oldData = new MySqLiteConnector(getContext()).getCourse4_1();
    ...
    private void saveNewCourse(String course, String credit) {
        boolean insert = connector.saveCourse4_1(course, credit);
        if(insert) {
    ...
    private void saveTimelineCourse(String course, String grade) {
        boolean insert = connector.saveTimelineCourse4_1(course, grade);
        if(insert) {
            Toast.makeText(getContext(), "Saved", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(getContext(), " Couldn't Save", Toast.LENGTH_LONG).show();
    ...
    public void getPosition(int position, String data) {
        ArrayList<CourseList> list = connector.getCourse4_1();
        int id = list.get(position).getId();
        connector.updateCredit4_1(id, data);
    }

    @Override
    public void OnLongClick(final int position) {
        ArrayList<CourseList> list2 = connector.getCourse4_1();
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                connector.deleteFromCourse4_1(id, course);
                connector.deleteFromTimelineCourse4_1(id, course);
