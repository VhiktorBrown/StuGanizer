 ...
 */
public class SecondSemester4 extends Fragment implements RecyclerInterface, ClickInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_second_semester4, container, false);
        ...
        adapter = new CourseListAdapter(context, SecondSemester4.this, courseListArrayList, this, this);
        ...
        ArrayList<CourseList> oldData = new MySqLiteConnector(getContext()).getCourse4_2();
    ...
    private void saveNewCourse(String course, String credit) {
        boolean insert = connector.saveCourse4_2(course, credit);
        if(insert) {
    ...
    private void saveTimelineCourse(String course, String grade) {
        boolean insert = connector.saveTimelineCourse4_2(course, grade);
        if (insert) {
            Toast.makeText(getContext(), "Saved", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(getContext(), " Couldn't Save", Toast.LENGTH_LONG).show();
    ...
    public void getPosition(int position, String data) {
        ArrayList<CourseList> list = connector.getCourse4_2();
        int id = list.get(position).getId();
        connector.updateCredit4_2(id, data);
    }

    @Override
    public void OnLongClick(final int position) {
        ArrayList<CourseList> list2 = connector.getCourse4_2();
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                connector.deleteFromCourse4_2(id, course);
                connector.deleteFromTimelineCourse4_2(id, course);
