 ...
 */
public class TimelineFirst5 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_timeline_first5, container, false);
        ...
        adapter = new TimelineListAdapter(context, TimelineFirst5.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit5_1();
        ArrayList<TimelineList> allGrades = connector.getGrade5_1();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse5_1();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse5_1();
        if (list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade5_1(id, data);
        }
