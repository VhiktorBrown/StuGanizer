 ...
 */
public class TimelineFirst2 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_timeline_first2, container, false);
        ...
        adapter = new TimelineListAdapter(context, TimelineFirst2.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit2_1();
        ArrayList<TimelineList> allGrades = connector.getGrade2_1();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse2_1();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse2_1();
        if(list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade2_1(id, data);
        }
