 ...
 */
public class TotalGpa3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_total_gpa3, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<CourseList> credit = connector.getCredit3_1();
                ArrayList<CourseList> credit2 = connector.getCredit3_2();
                ArrayList<TimelineList> grade = connector.getGrade3_1();
                ArrayList<TimelineList> grade2 = connector.getGrade3_2();
