 ...
 */
public class TimelineFirst4 extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_timeline_first4, container, false);
        ...
        adapter = new TimelineListAdapter(context, TimelineFirst4.this, timelineListArrayList, this);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit4_1();
        ArrayList<TimelineList> allGrades = connector.getGrade4_1();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse4_1();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse4_1();
        if (list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade4_1(id, data);
        }
