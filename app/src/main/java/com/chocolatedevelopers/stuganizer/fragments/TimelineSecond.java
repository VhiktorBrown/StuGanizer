 ...
 */
public class TimelineSecond extends Fragment implements RecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view = inflater.inflate(R.layout.fragment_timeline_second, container, false);
        context = getContext();
        recyclerView = view.findViewById(R.id.timeline_recycler_2);
        timelineListArrayList = new ArrayList<>();
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        adapter = new TimelineListAdapter(context, TimelineSecond.this, timelineListArrayList, this);
       ...
       textResult = view.findViewById(R.id.result_text2);
        ...
        ArrayList<CourseList> allCredits = connector.getCredit1_2();
        ArrayList<TimelineList> allGrades = connector.getGrade1_2();
        ...
        ArrayList<TimelineList> allData = connector.getTimelineCourse1_2();
        if(allData.size() > 0) {
    ...
    public void getPosition(int position, String data) {
        ArrayList<TimelineList> list = connector.getTimelineCourse1_2();
        if(list.size() > 0) {
            int id = list.get(position).getId();
            connector.updateGrade1_2(id, data);
        }
