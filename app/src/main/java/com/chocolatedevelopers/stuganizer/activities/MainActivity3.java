...
import com.chocolatedevelopers.stuganizer.adapters.PagerAdapter3;
...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PagerAdapter3(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT, tabLayout.getTabCount());
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id) {
                    ...
                    case R.id.help_a_friend:
                        startActivity(new Intent(MainActivity3.this, HelpAFriend.class));
                        finish();
                        break;
                    case R.id.my_notes:
                        startActivity(new Intent(MainActivity3.this, NotesActivity.class));
                        finish();
                        break;
                    case R.id.timeline:
                        startActivity(new Intent(MainActivity3.this, Timeline.class));
                        finish();
                        break;
                    case R.id.school_timetable:
                        startActivity(new Intent(MainActivity3.this, TimeTable.class));
                        finish();
                        break;
                    case R.id.settings:
