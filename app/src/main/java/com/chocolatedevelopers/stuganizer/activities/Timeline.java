...
import com.chocolatedevelopers.stuganizer.adapters.PagerAdapterT;
...
public class Timeline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PagerAdapterT(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT, tabLayout.getTabCount());
        ...
        bottomNavigationView.setSelectedItemId(R.id.year_1);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id) {
                    ...
                    case R.id.help_a_friend:
                        startActivity(new Intent(Timeline.this, HelpAFriend.class));
                        finish();
                        break;
                    case R.id.my_notes:
                        startActivity(new Intent(Timeline.this, NotesActivity.class));
                        finish();
                        break;
                    case R.id.timeline:
                    ...
                    case R.id.school_timetable:
                        startActivity(new Intent(Timeline.this, TimeTable.class));
                        finish();
                        break;
                    case R.id.settings:
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.year_1:
                    ...
                    return true;
                case R.id.year_2:
                    startActivity(new Intent(Timeline.this, Timeline2.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_3:
                    startActivity(new Intent(Timeline.this, Timeline3.class));
                    overridePendingTransition(0, 0);
                    finish();
                   return true;
                case R.id.year_4:
                    startActivity(new Intent(Timeline.this, Timeline4.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_5:
                    startActivity(new Intent(Timeline.this, Timeline5.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
            }
