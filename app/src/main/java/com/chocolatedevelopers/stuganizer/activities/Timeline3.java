...
import com.chocolatedevelopers.stuganizer.adapters.PagerAdapterT3;
...
public class Timeline3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PagerAdapterT3(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT, tabLayout.getTabCount());
        ...
        bottomNavigationView.setBackgroundColor(getResources().getColor(R.color.violetRed));
        bottomNavigationView.setSelectedItemId(R.id.year_3);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id) {
                    case R.id.my_courses:
                        startActivity(new Intent(Timeline3.this, MainActivity.class));
                        finish();
                        break;
                    case R.id.help_a_friend:
                        startActivity(new Intent(Timeline3.this, HelpAFriend.class));
                        finish();
                        break;
                    case R.id.my_notes:
                        startActivity(new Intent(Timeline3.this, NotesActivity.class));
                        finish();
                        break;
                    case R.id.timeline:
                    ...
                    case R.id.school_timetable:
                        startActivity(new Intent(Timeline3.this, TimeTable.class));
                        finish();
                        break;
                    case R.id.settings:
                        startActivity(new Intent(Timeline3.this, Settings.class));
                        break;
                    case R.id.help_and_feedback:
                        startActivity(new Intent(Timeline3.this, About.class));
                        break;
                    default:
                        return true;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener navListener = new BottomNavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.year_1:
                    startActivity(new Intent(Timeline3.this, Timeline.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_2:
                    startActivity(new Intent(Timeline3.this, Timeline2.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_3:
                    ...
                    return true;
                case R.id.year_4:
                    startActivity(new Intent(Timeline3.this, Timeline4.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_5:
                    startActivity(new Intent(Timeline3.this, Timeline5.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
            }
