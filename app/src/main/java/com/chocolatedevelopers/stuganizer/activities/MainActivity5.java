...
import com.chocolatedevelopers.stuganizer.adapters.PagerAdapter5;
...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PagerAdapter5(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT, tabLayout.getTabCount());
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id) {
                    ...
                    case R.id.help_a_friend:
                        startActivity(new Intent(MainActivity5.this, HelpAFriend.class));
                        finish();
                        break;
                    case R.id.my_notes:
                        startActivity(new Intent(MainActivity5.this, NotesActivity.class));
                        finish();
                        break;
                    case R.id.timeline:
                        startActivity(new Intent(MainActivity5.this, Timeline.class));
                        finish();
                        break;
                    case R.id.school_timetable:
                        startActivity(new Intent(MainActivity5.this, TimeTable.class));
                        finish();
                        break;
                    case R.id.settings:
                        startActivity(new Intent(MainActivity5.this, Settings.class));
                        break;
                    case R.id.help_and_feedback:
                        startActivity(new Intent(MainActivity5.this, About.class));
                        break;
                    default:
                        return true;
