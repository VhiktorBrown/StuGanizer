...
import com.chocolatedevelopers.stuganizer.adapters.PagerAdapterT2;
...
public class Timeline2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PagerAdapterT2(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT, tabLayout.getTabCount());
        ...
        bottomNavigationView.setSelectedItemId(R.id.year_2);
        bottomNavigationView.setBackgroundColor(getResources().getColor(R.color.sunriseOrange));
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id) {
                    case R.id.my_courses:
                        startActivity(new Intent(Timeline2.this, MainActivity.class));
                        finish();
                        break;
                    case R.id.help_a_friend:
                        startActivity(new Intent(Timeline2.this, HelpAFriend.class));
                        finish();
                        break;
                    case R.id.my_notes:
                        startActivity(new Intent(Timeline2.this, NotesActivity.class));
                        finish();
                        break;
                    case R.id.timeline:
                    ...
                    case R.id.school_timetable:
                        startActivity(new Intent(Timeline2.this, TimeTable.class));
                        finish();
                        break;
                    case R.id.settings:
                        startActivity(new Intent(Timeline2.this, Settings.class));
                        break;
                    case R.id.help_and_feedback:
                        startActivity(new Intent(Timeline2.this, About.class));
                        break;
                    default:
                        return true;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener navListener = new BottomNavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.year_1:
                    startActivity(new Intent(Timeline2.this, Timeline.class));
                ...
                case R.id.year_2:
                    ...
                    return true;
                case R.id.year_3:
                    startActivity(new Intent(Timeline2.this, Timeline3.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_4:
                    startActivity(new Intent(Timeline2.this, Timeline4.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
                case R.id.year_5:
                    startActivity(new Intent(Timeline2.this, Timeline5.class));
                    overridePendingTransition(0, 0);
                    finish();
                    return true;
            }
